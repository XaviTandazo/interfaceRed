...
def bloquear_mac_apagando_interfaz(mac_objetivo):
    ...
    try:
        ...
        # Registrar la MAC como bloqueada junto con la IP
...
# Función para permitir una MAC (encendiendo la interfaz)
def permitir_mac_encendiendo_interfaz(mac_objetivo):
    ...
    try:
        ...
        if os.path.exists(BLOCKED_MACS_FILE):
            ...
            macs = [m for m in macs if m[0].lower() != mac_objetivo.lower()]
